	...
	private static class MyAdditionThread extends Thread {
	      ...
	      public void run() {
	        ...
	        int c = a + b;
	            ...
	            synchronized (subLock) {System.out.println("Threads: Holding Add and Sub Locks...");}
   ...
   private static class MySubtractionThread extends Thread {
	   ...
	   public void run() {
		   ...
		   synchronized (subLock) {
				...
				synchronized (addLock) {System.out.println("Threads: Holding Add and Sub Locks...");}
